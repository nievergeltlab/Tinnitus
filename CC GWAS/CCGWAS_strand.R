CCGWAS_strand <- function( outcome_file , A_name , B_name , sumstats_fileA1A0 , sumstats_fileB1B0 , K_A1A0 , K_A1A0_high , K_A1A0_low , K_B1B0 , K_B1B0_high ,K_B1B0_low ,
...
###########################
  ...
  ## Delete strand ambiguous SNPs #SKIP THIS STEP
